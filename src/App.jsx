            ...
            <div className="flex items-start">
              ...
              <div className="flex-1 space-y-4">
                <div>
                  ...
                  <div className="text-white/90 text-sm sm:text-base font-semibold mt-1">String Bio Pvt. Ltd,</div>
                  <div className="text-white/90 text-xs sm:text-sm mt-0.5">No.456 G,1st Main Road,</div>
                  <div className="text-white/90 text-xs sm:text-sm mt-0.5">Vinayaka Nagar,Opposite Kennametal Widia,</div>
                  <div className="text-white/90 text-xs sm:text-sm mt-0.5">9th Mile, Tumkur Road, Nagasandra, Bengaluru, Karnataka-560073</div>
                </div>

                <div className="pt-4 border-t border-white/20">
                  <div className="text-[#d9c98f] text-sm">Marketed By:</div>
                  <div className="text-white/90 text-sm sm:text-base font-semibold mt-1">Harlal Seeds Private Limited,,</div>
                  <div className="text-white/90 text-xs sm:text-sm mt-0.5">  Plot No.3,APMC Yard, Agro V Type Agro Line,</div>
                  <div className="text-white/90 text-xs sm:text-sm mt-0.5">Near Udachemma Temple,Amargol,Hubballi,</div>
                  ...
                  <div className="text-white/90 text-xs sm:text-sm mt-1">Phone: 9743386869</div>
                  <div className="text-white/90 text-xs sm:text-sm mt-0.5">E-Mail: sunilyvrgroup@gmail.com</div>
                </div>
              </div>
           </div> 
          </StarBorder>
          <StarBorder as="div" className="w-full" color="cyan" speed="5s" thickness={2}>
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <div className="text-white/90 text-sm sm:text-base">+91 9743386869</div>
              </div>
            </div>
          </StarBorder>
        </section>
